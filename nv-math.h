...
// larmor frequency of NV center due to zero-field splitting and static magnetic field
...
inline MatrixXcd U_NV(const Vector3d axis, const double phi, const uint spins = 1){
